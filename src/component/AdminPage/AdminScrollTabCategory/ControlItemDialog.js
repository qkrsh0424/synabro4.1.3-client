        ...
        <Dialog open={props.selectDialogOpen} onClose={props._handleSelectDialogClose} aria-labelledby="form-dialog-title">
            ...
            <DialogContent>
                ...
                <TextField
                    ...
                    label="카테고리 타이틀"
                    type="text"
                    value={props.selectedItem?props.selectedItem.shb_item_name:''}
            ...
            <DialogActions>
                ...
                <Button onClick={props._handleFinalDeleteAlertOpen} color="secondary">
                    삭제하기
                </Button>
            ...
            {props.deleteAlertOpen?
                (<DialogContent>
                    <DialogContentText>
                        카테고리를 삭제하시면 관련된 포스터들도 삭제됩니다. 정말로 진행하시겠습니까 ?
                        <Button onClick={props._handleDeleteSubCategory} color="secondary" >
                            삭제
                        </Button>
                        <Button onClick={props._handleFinalDeleteAlertClose} color="default">
                            취소
                        </Button>
                    </DialogContentText>
                </DialogContent>):""
