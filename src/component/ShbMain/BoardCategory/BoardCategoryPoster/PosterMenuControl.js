...
class UnivPosterMenuControl extends React.Component {
    ...
    handleModifyPoster = () => {
        ...
        if(this.props.poster_isValidation){
            window.location.href=`/main/modifypost?BomNo=${this.props.queryValues.BomNo}&Category=${this.props.match.params.shb_item_id}&postView=${this.props.match.params.post_id}`;
        }
