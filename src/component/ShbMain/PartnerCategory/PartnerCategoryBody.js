...
const PartnerCategoryBody = (props) => {
    const {
        partnerApplyFormOpen
    } = props;
    const {
        handleCheckLogin
    } = props;
        ...
        <Container className="container my-3 shadow-sm animate slideIn clearfix">
            <div style={style.Grid}>
                ...
                >
                    ...
                    {partnerApplyFormOpen ? <Button type='button' onClick={handleCheckLogin}>폼 닫기</Button> : <Button type='button' onClick={handleCheckLogin}>파트너 신청하기</Button>}
